        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="quickForm" action="{{route('data-barang/edit/post',$barang->kode_barang)}}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="form-floating">
                                <label for="floatingInput">Kode Barang</label>
                                <input readonly type="text" name="kode_barang" class="form-control @error('kode_barang')is-invalid @enderror" id="kode_barang" required value="{{$barang->kode_barang}}">
                                @error('kode_barang')
                            ...
                            <div class="form-floating">
                                ...
                                <input type="text" name="satuan" class="form-control @error('satuan')is-invalid @enderror" id="satuan" placeholder="Masukan Satuan Barang" required value="{{$barang->satuan}}" onchange="reSum();">
                                @error('satuan')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="form-floating">
                                ...
                                <input type="text" name="Qty" class="form-control @error('Qty')is-invalid @enderror" id="Qty" placeholder="Masukan Qty" required value="{{$barang->Qty}}" onchange="reSum();">
                                @error('Qty')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="form-floating">
                                ...
                                <select class="form-control @error('id_kategori')is-invalid @enderror" name="id_kategori" required id="id_kategori">
                                    ...
                                    <option value="{{ $kat->id_kategori }}" {{$kat->id_kategori == $kat->id_kategori  ? 'selected' : ''}} readonly>{{ $kat->nama_kategori}}</option>
                                    @endforeach
                                </select>
                                @error('id_kategori')
                                <div class="invalid-feedback">
