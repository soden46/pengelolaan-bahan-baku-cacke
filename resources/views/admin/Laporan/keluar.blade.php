        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <form action="/barang-masuk" method="GET" class="d-flex justify-content-start px-2">
                        <span>Filter Tanggal Laporan Penjualan</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <table id="dataTable" name="dataTable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>$data->count() * ($data->currentPage() - 1) + $loop->iteration</td>
                                ...
                                <form action="{{ route('laporan/barang-keluar/pdf') }}" method="GET" class="d-flex justify-content-end px-2">
